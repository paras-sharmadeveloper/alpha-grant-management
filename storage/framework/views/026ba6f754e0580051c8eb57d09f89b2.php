	...
	<div class="<?php echo e($alert_col); ?>">
		<div class="card">
			<div class="card-header">
				<span class="panel-title"><?php echo e(_lang('Add New Memeber')); ?></span>
			</div>
			<div class="card-body">
			    <form method="post" class="validate" autocomplete="off" action="<?php echo e(route('admin.tenants.store')); ?>" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
					<div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <div class="form-control pr-0 d-flex align-items-center parent-box">
                                        ...
                                        <input type="text" class="form-control no-msg" name="workspace" value="<?php echo e(old('workspace')); ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <select class="form-control auto-select" data-selected="<?php echo e(old('membership_type', 'member')); ?>" name="membership_type" required>
                            ...
                            <div class="form-group row mt-4">
                                <div class="col-xl-9 offset-xl-3 text-right">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti-check-box mr-2"></i> <?php echo e(_lang('Save')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u554938499/domains/app.alphagrantmanagement.com.au/public_html/resources/views/backend/super_admin/tenant/create.blade.php ENDPATH**/ ?>