    ...
    <div class="<?php echo e($alert_col); ?>">
        ...
        <div class="card">
            <div class="card-header">
                <span class="panel-title"><?php echo e(_lang('Loan Enquiry Form')); ?></span>
            </div>
            <div class="card-body">
                ...
                <form method="post" id="enquiry-form" autocomplete="off" novalidate
                      action="<?php echo e(route('loans.apply_loan')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="enq_full_name" value="<?php echo e(old('enq_full_name', $member->name ?? '')); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Mobile <span class="required"> *</span></label>
                                    <input type="text" class="form-control" name="enq_mobile" value="<?php echo e(old('enq_mobile', $member->mobile ?? '')); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Email <span class="required"> *</span></label>
                                    <input type="email" class="form-control" name="enq_email" value="<?php echo e(old('enq_email', $member->email ?? '')); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                    ...
                    <div class="enquiry-step" id="step-2" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6" id="term-field" style="display:none;">
                                <div class="form-group">
                                    <label class="control-label"><?php echo e(_lang('Term')); ?> <span id="term-range-label" class="text-muted" style="font-size:12px;"></span></label>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <div class="ml-auto">
                            ...
                            <button type="submit" class="btn btn-success" id="btn-submit" style="display:none;">
                                <i class="ti-check-box"></i>&nbsp;<?php echo e(_lang('Submit Application')); ?>
        ...
        <div class="card">
            <div class="card-header">
                <span class="panel-title"><?php echo e(_lang('My Loan Applications')); ?></span>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover mb-0" style="font-family:Poppins,sans-serif;font-size:13px;">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $myLoans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr>
                                <td><?php echo e($i + 1); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($loan->getRawOriginal('created_at'))->format('d M Y')); ?></td>
                                <td><?php echo e($loan->loan_product->name ?? '—'); ?></td>
                                <td>AUD <?php echo e(number_format($loan->applied_amount, 2)); ?></td>
                                <td><?php echo e($loan->enq_loan_purpose ?? '—'); ?></td>
                                <td><?php echo e($loan->enq_monthly_revenue ?? '—'); ?></td>
                                <td><?php echo e(ucfirst($loan->enq_security_type ?? '—')); ?></td>
                                <td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-xs btn-outline-primary btn-view-detail"
                                        data-id="<?php echo e($loan->id); ?>"
                                        data-name="<?php echo e($loan->enq_full_name); ?>"
                                        data-mobile="<?php echo e($loan->enq_mobile); ?>"
                                        data-email="<?php echo e($loan->enq_email); ?>"
                                        data-business="<?php echo e($loan->enq_business_name); ?>"
                                        data-gst="<?php echo e($loan->enq_gst_registered ? 'Yes' : 'No'); ?>"
                                        data-years="<?php echo e($loan->enq_years_operating); ?>"
                                        data-abn="<?php echo e($loan->enq_abn_acn); ?>"
                                        data-product="<?php echo e($loan->loan_product->name ?? ''); ?>"
                                        data-amount="<?php echo e(number_format($loan->applied_amount, 2)); ?>"
                                        data-purpose="<?php echo e($loan->enq_loan_purpose); ?>"
                                        data-time="<?php echo e($loan->enq_time_in_business); ?>"
                                        data-revenue="<?php echo e($loan->enq_monthly_revenue); ?>"
                                        data-ato="<?php echo e($loan->enq_ato_debt ? 'Yes' : 'No'); ?>"
                                        data-defaults="<?php echo e($loan->enq_defaults ? 'Yes' : 'No'); ?>"
                                        data-existing="<?php echo e($loan->enq_existing_loans ? 'Yes' : 'No'); ?>"
                                        data-security="<?php echo e(ucfirst($loan->enq_security_type)); ?>"
                                        data-asset="<?php echo e($loan->enq_asset_type); ?>"
                                        data-funds="<?php echo e($loan->enq_funds_needed_by); ?>"
                                        data-contact="<?php echo e($loan->enq_best_contact_time); ?>"
                                        data-consent="<?php echo e($loan->enq_consent ? 'Yes' : 'No'); ?>"
                                        data-date="<?php echo e(\Carbon\Carbon::parse($loan->getRawOriginal('created_at'))->format('d M Y')); ?>">
