...
<div class="row">
	<div class="col-lg-8 offset-lg-2">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" class="validate" autocomplete="off" action="<?php echo e(route('loan_products.update', $id)); ?>" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="loan_id_prefix" value="<?php echo e($loanproduct->loan_id_prefix); ?>">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" class="form-control" name="starting_loan_id" value="<?php echo e($loanproduct->starting_loan_id); ?>" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" class="form-control" name="min_term" value="<?php echo e($loanproduct->min_term ?? 1); ?>" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control select2 auto-select" data-selected="<?php echo e($loanproduct->term_period); ?>" name="term_period" id="term_period" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control float-field" name="late_payment_penalties" value="<?php echo e($loanproduct->late_payment_penalties); ?>" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="loan_application_fee" value="<?php echo e($loanproduct->loan_application_fee); ?>" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control auto-select" data-selected="<?php echo e($loanproduct->loan_application_fee_type); ?>" name="loan_application_fee_type" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="loan_processing_fee" value="<?php echo e($loanproduct->loan_processing_fee); ?>" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control auto-select" data-selected="<?php echo e($loanproduct->loan_processing_fee_type); ?>" name="loan_processing_fee_type" required>
									<option value="0"><?php echo e(_lang('Fixed')); ?></option>
									<option value="1"><?php echo e(_lang('Percentage')); ?></option>
								</select>
							</div>
						...
						<div class="col-md-12 mt-2">
							<div class="form-group">
								<button type="submit" class="btn btn-primary"><i class="ti-check-box"></i>&nbsp;<?php echo e(_lang('Update Changes')); ?></button>
							</div>
						</div>
					</div>
				</form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\alpha-grant-management\resources\views/backend/admin/loan_product/edit.blade.php ENDPATH**/ ?>