		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="report-params">
					<form class="validate" method="post" action="<?php echo e(route('customer_reports.account_statement')); ?>" autocomplete="off">
						<div class="row">
              				<?php echo csrf_field(); ?>
							...
							<div class="col-xl-3 col-lg-4">
								<div class="form-group">
									...
									<select class="form-control auto-select" data-selected="<?php echo e(isset($account_number) ? $account_number : old('account_number')); ?>" name="account_number" required>
				...
				<div class="report-header">
				   ...
				   <p><?php echo e(_lang('Account Statement')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u554938499/domains/app.alphagrantmanagement.com.au/public_html/resources/views/backend/customer/reports/account_statement.blade.php ENDPATH**/ ?>