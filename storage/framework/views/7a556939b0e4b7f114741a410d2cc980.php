...
$(document).ready(function () {
    ...
    function updateTermField() {
        ...
        try {
            ...
            var yearsLabel = '';
            if (tp === 'month') yearsLabel = ' <span class="text-muted" style="font-size:11px;">(' + Math.floor(minTerm/12) + '–' + Math.ceil(maxTerm/12) + ' years)</span>';
            ...
            $('#term-hint').text('Min: ' + minTerm + ' — Max: ' + maxTerm + (tp === 'month' ? ' months (' + (minTerm/12).toFixed(1) + '–' + (maxTerm/12).toFixed(1) + ' years)' : ''));
