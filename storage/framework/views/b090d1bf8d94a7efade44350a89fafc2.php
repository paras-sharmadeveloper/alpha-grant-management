...
<!-- Header-->
<header class="bg-header aboutus">
    <div class="container px-4">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xxl-6">
                <div class="text-center my-5">
                    <h3 class="wow animate__zoomIn"><?php echo e($page_title); ?></h3>
                    <ul class="list-inline breadcrumbs text-capitalize">
                        <li class="list-inline-item"><a href="<?php echo e(url('/')); ?>"><?php echo e(_lang('Home')); ?></a></li>
                        <li class="list-inline-item">/ &nbsp; <a href="<?php echo e(url('/about')); ?>"><?php echo e(_lang('About')); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-7">
                <div class="section-title">
                    <h2 class="mb-4 wow animate__fadeInUp" data-wow-delay="0.2s"><?php echo e(isset($pageData->section_1_heading) ? $pageData->section_1_heading : ''); ?></h2>
                    <div class="content pe-0 pe-lg-5 wow animate__fadeInUp" data-wow-delay="0.4s">
                        <?php echo isset($pageData->section_1_content) ? xss_clean($pageData->section_1_content) : ''; ?>

                    </div>
                </div>
            </div>
            <div class="col-lg-5 mt-5 mt-lg-0 wow animate__fadeInRight" data-wow-delay="0.4s">
                <img src="<?php echo e(isset($pageMedia->about_image) ? asset('public/uploads/media/'.$pageMedia->about_image) : asset('public/website/assets/about-us.jpg')); ?>" alt="" class="rounded w-100">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-around">
            <div class="col-lg-5 wow animate__fadeInLeft">
                <div class="section-title">
                    ...
                    <h2><?php echo e(isset($pageData->section_2_heading) ? $pageData->section_2_heading : ''); ?></h2>
                </div>
                <?php echo isset($pageData->section_2_content) ? xss_clean($pageData->section_2_content) : ''; ?>

            </div>
            <div class="col-lg-5 wow animate__fadeInRight">
                <div class="section-title">
                    <p class="text-primary text-uppercase fw-bold mb-3"></p>
                    <h2><?php echo e(isset($pageData->section_3_heading) ? $pageData->section_3_heading : ''); ?></h2>
                </div>
                <?php echo isset($pageData->section_3_content) ? xss_clean($pageData->section_3_content) : ''; ?>
        ...
        <div class="row gx-5 justify-content-center">
            <div class="col-lg-8 col-xl-6">
                <div class="text-center section-header">
                    <h3 class="wow animate__zoomIn"><?php echo e(_lang('Teams')); ?></h3>
                    <h2 class="wow animate__fadeInUp"><?php echo e(isset($pageData->team_heading) ? $pageData->team_heading : ''); ?></h2>
                    <p class="wow animate__fadeInUp"><?php echo e(isset($pageData->team_sub_heading) ? $pageData->team_sub_heading : ''); ?></p>
                </div>
            </div>
        </div>

        <div class="row gx-5 justify-content-center">
            <?php $__currentLoopData = $team_members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card team rounded shadow-lg h-100">
                    <div class="card-body d-flex align-items-center flex-column justify-content-center text-center p-5">
                        <picture class="avatar">
                            <img class="img-fluid rounded-circle" src="<?php echo e(asset('public/uploads/media/'.$team->image)); ?>" alt="">
                        </picture>
                        <p class="lead fw-bolder mb-0 mt-4 text-dark"><?php echo e($team->translation->name); ?></p>
                        <p class="text-primary small fw-bold mb-4"><?php echo e($team->translation->role); ?></p>
                        <p><?php echo e($team->translation->description); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('website.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u554938499/domains/app.alphagrantmanagement.com.au/public_html/resources/views/website/about.blade.php ENDPATH**/ ?>