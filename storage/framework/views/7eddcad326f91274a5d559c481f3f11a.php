					...
					<table class="table table-bordered text-center">
						<thead>
							<tr>
								...
								<th class="text-nowrap"><?php echo e(_lang('Amount to Pay')); ?></th>
						...
						<tbody>
							<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($loans) == 0): ?>
								<tr>
									<td colspan="5">
										<p class="text-center"><?php echo e(_lang('No Data Available')); ?></p>
									</td>
								</tr>
							...
							<tr>
								...
								<td>
									<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loan->next_payment->getRawOriginal('repayment_date') >= date('Y-m-d')): ?>
								...
								<td>
									<?php echo e(decimalPlace($loan->next_payment->amount_to_pay, currency($loan->currency->name))); ?>
