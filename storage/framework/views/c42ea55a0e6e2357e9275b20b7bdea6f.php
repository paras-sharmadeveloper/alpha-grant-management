					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control auto-select select2" data-selected="<?php echo e(old('loan_id')); ?>" id="loan_id" name="loan_id" required>
									...
									<?php $__currentLoopData = \App\Models\Loan::with(['currency', 'borrower'])->where('status',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select class="form-control auto-select select2" data-selected="<?php echo e(old('loan_id', 'cash')); ?>" id="account_id" name="account_id" required>
									<option value="cash"><?php echo e(_lang('Cash Amount')); ?></option>
								</select>
							</div>
						</div>
...
<script>
	...
	$(document).on('change','#loan_id',function(){
		...
		if( loan_id != '' ){
			$.ajax({
				url: _tenant_url + "/loan_payments/get_repayment_by_loan_id/" + loan_id,
				beforeSend: function(){
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u554938499/domains/app.alphagrantmanagement.com.au/public_html/resources/views/backend/admin/loan_payment/create.blade.php ENDPATH**/ ?>