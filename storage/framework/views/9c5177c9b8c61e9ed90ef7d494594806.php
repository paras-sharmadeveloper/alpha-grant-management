		...
		<div class="col-lg-4">
			<div class="card">
				...
				<div class="card-body" id="client_login_card">
					<div class="row">
						<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->tenant->package->member_portal != 1): ?>
						<div class="col-md-12">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\alpha-grant-management\resources\views/backend/admin/member/create.blade.php ENDPATH**/ ?>