                ...
                <div class="tab-pane fade mt-4" id="guarantor">
                    <div class="table-responsive">
                        <table id="guarantors_table" class="table table-bordered">
                            ...
                            <tbody>
                                <?php if($loan->guarantors->count() == 0): ?>
                                <tr>
                ...
                <div class="tab-pane fade mt-4" id="collateral">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $loan->collaterals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loancollateral): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table class="table table-bordered report-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if($repayment['status'] == 0 && $loan->next_payment->id == $repayment->id): ?>
                                        <a href="<?php echo e(route('loans.loan_payment', $repayment->loan_id)); ?>" class="btn btn-primary btn-xs"><?php echo e(_lang('Pay Now')); ?></a>
                        ...
                        <table class="table table-bordered report-table">
                            ...
                            <tbody>
                               ...
                               <?php if(!empty($loan->documents)): ?>
                                    ...
                                    <?php $__currentLoopData = $loan->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u554938499/domains/app.alphagrantmanagement.com.au/public_html/resources/views/backend/customer/loan/loan_details.blade.php ENDPATH**/ ?>