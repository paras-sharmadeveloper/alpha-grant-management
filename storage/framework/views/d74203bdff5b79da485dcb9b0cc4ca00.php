        ...
        <div class="col-md-5">
            <div class="card card-signin p-3 my-5">
                <div class="card-body">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$adminLogin): ?>
					...
					<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Session::has('registration_success')): ?>
                        <div class="alert alert-success text-center">
					...
					<form method="POST" class="form-signin" action="<?php echo e($postUrl); ?>">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$adminLogin && get_tenant_option('members_sign_up', 0, app('tenant')->id) == 1): ?>
                                    <a href="<?php echo e(route('tenant.members_signup')); ?>" class="btn btn-dark btn-block"><?php echo e(_lang('Member Sign Up')); ?></a>
                                <?php else: ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(get_option('member_signup') == 1): ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(get_option('enable_recaptcha', 0) == 1): ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/app-alpha/resources/views/auth/login.blade.php ENDPATH**/ ?>