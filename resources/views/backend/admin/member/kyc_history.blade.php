                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-xs btn-outline-secondary" data-toggle="modal" data-target="#hmodal_{{ $v->id }}" title="Raw JSON">
                                    <i class="fas fa-eye"></i>
                                </button>
                                --}}
                                <button class="btn btn-xs btn-outline-primary" data-toggle="modal" data-target="#hfmodal_{{ $v->id }}" title="View Details">
...
@php
    ...
    $warnings = $nested['warnings'] ?? [];
@endphp
<div class="modal fade" id="hfmodal_{{ $v->id }}" tabindex="-1">
    <div class="modal-dialog modal-lg">
