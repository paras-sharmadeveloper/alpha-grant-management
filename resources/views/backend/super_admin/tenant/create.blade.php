	...
	<div class="{{ $alert_col }}">
		<div class="card">
			<div class="card-header">
				<span class="panel-title">{{ _lang('Add New Memeber') }}</span>
			</div>
			<div class="card-body">
			    <form method="post" class="validate" autocomplete="off" action="{{ route('admin.tenants.store') }}" enctype="multipart/form-data">
					@csrf
					<div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <div class="form-control pr-0 d-flex align-items-center parent-box">
                                        ...
                                        <input type="text" class="form-control no-msg" name="workspace" value="{{ old('workspace') }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <select class="form-control auto-select" data-selected="{{ old('membership_type', 'member') }}" name="membership_type" required>
                            ...
                            <div class="form-group row mt-4">
                                <div class="col-xl-9 offset-xl-3 text-right">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti-check-box mr-2"></i> {{ _lang('Save') }}
                                    </button>
                                </div>
                            </div>
                        </div>
