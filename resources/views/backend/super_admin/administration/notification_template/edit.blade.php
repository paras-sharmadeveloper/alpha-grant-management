	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-body">
				...
				@if($emailtemplate->template_type == 'tenant')
				<div class="col-md-12">
					<div class="alert alert-warning">
						<i class="fas fa-exclamation-circle mr-1"></i> {{ _lang("This template is used for tenant notification. You can edit this template for new tenants but you can't enable it for tenant") }}
					</div>
				</div>
				@endif

				<form method="post" class="validate" autocomplete="off" action="{{ route('admin.notification_templates.update', $id) }}" enctype="multipart/form-data">
					@csrf
