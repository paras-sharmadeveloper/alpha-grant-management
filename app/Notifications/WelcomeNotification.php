...
class WelcomeNotification extends Notification {
    ...
    public function __construct($user) {
        ...
        $this->template = EmailTemplate::where('slug', 'WELCOME_EMAIL')->first();

        $this->replace['customerName'] = $user->name;
        $this->replace['loginLink']    = route('tenant.login', ['tenant' => $user->tenant->slug]);
    }
