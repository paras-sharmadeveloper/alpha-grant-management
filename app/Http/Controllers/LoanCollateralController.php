...
class LoanCollateralController extends Controller {
     ...
     */
    public function index($tenant, $loan_id) {
        $loancollaterals = LoanCollateral::where('loan_id', $loan_id)
            ->orderBy("id", "desc")
            ->get();
        return view('backend.admin.loan_collateral.list', compact('loancollaterals', 'loan_id'));
    }
    ...
    public function create(Request $request) {
        ...
        if (! $request->ajax()) {
            return view('backend.admin.loan_collateral.create', compact('loan_id', 'alert_col'));
        } else {
            return view('backend.admin.loan_collateral.modal.create', compact('loan_id'));
        }
    }
    ...
    public function show(Request $request, $tenant, $id) {
        ...
        if (! $request->ajax()) {
            return view('backend.admin.loan_collateral.view', compact('loancollateral', 'id'));
        } else {
            return view('backend.admin.loan_collateral.modal.view', compact('loancollateral', 'id'));
        }
    ...
    public function edit(Request $request, $tenant, $id) {
        ...
        $loancollateral = LoanCollateral::find($id);
        if (! $request->ajax()) {
            return view('backend.admin.loan_collateral.edit', compact('loancollateral', 'id', 'alert_col'));
        } else {
            return view('backend.admin.loan_collateral.modal.edit', compact('loancollateral', 'id', 'alert_col'));
        }
